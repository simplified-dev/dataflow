...
class DeserializeTransformTest {
    ...
    void deserialisesRecord() {
        ...
        Sample result = DeserializeTransform.of(SAMPLE_TYPE)
    ...
    void outputTypeMatches() {
        DeserializeTransform<?, Sample> stage = DeserializeTransform.of(SAMPLE_TYPE);
    ...
    void acceptsJsonObjectInput() {
        DeserializeTransform<?, Sample> stage =
            DeserializeTransform.of(DataTypes.JSON_OBJECT, SAMPLE_TYPE);
