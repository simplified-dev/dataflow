...
class ObjectBuildTransformTest {
    ...
    void rejectsTypeMismatch() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            ObjectBuildTransform.over(DataTypes.STRING)
    ...
    void advertisesContract() {
        ObjectBuildTransform<String> stage = ObjectBuildTransform.over(DataTypes.STRING).build();
