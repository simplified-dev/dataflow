package dev.simplified.dataflow.stage.terminal;

import dev.simplified.dataflow.DataType;
import dev.simplified.dataflow.DataTypes;
import dev.simplified.dataflow.PipelineContext;
import dev.simplified.dataflow.stage.terminal.average.AverageDoubleCollect;
import dev.simplified.dataflow.stage.terminal.average.AverageIntCollect;
import dev.simplified.dataflow.stage.terminal.average.AverageLongCollect;
import dev.simplified.dataflow.stage.terminal.match.AllMatchCollect;
import dev.simplified.dataflow.stage.terminal.match.AnyMatchCollect;
import dev.simplified.dataflow.stage.terminal.match.FindFirstCollect;
import dev.simplified.dataflow.stage.terminal.match.NoneMatchCollect;
import dev.simplified.dataflow.stage.terminal.minmax.MaxCollect;
import dev.simplified.dataflow.stage.terminal.minmax.MinCollect;
import dev.simplified.dataflow.stage.terminal.sum.CountCollect;
import dev.simplified.dataflow.stage.terminal.sum.SumDoubleCollect;
import dev.simplified.dataflow.stage.terminal.sum.SumIntCollect;
import dev.simplified.dataflow.stage.terminal.sum.SumLongCollect;
import dev.simplified.dataflow.stage.transform.primitive.ParseBooleanTransform;
