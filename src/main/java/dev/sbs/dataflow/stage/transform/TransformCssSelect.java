...
public final class TransformCssSelect implements TransformStage<Element, List<Element>> {
     ...
     * @return the stage
     */
    public static @NotNull TransformCssSelect of(@NotNull String selector) {
        return new TransformCssSelect(selector);
    }
