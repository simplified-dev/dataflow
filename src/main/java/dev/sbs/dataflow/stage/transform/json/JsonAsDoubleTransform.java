...
public final class JsonAsDoubleTransform implements TransformStage<JsonElement, Double> {
     ...
     * @return the stage
     */
    public static @NotNull JsonAsDoubleTransform create() {
    ...
    /** {@inheritDoc} */
    @Override public @NotNull StageId kind()                    { return StageId.TRANSFORM_JSON_AS_DOUBLE; }
    /** {@inheritDoc} */
    @Override public @NotNull String summary()                  { return "JSON as double"; }
