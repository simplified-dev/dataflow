...
public final class FlatMapTransform<X, Y> implements TransformStage<List<X>, List<Y>> {
    ...
    public static <X, Y> @NotNull FlatMapTransform<X, Y> of(
        ...
        @Configurable(label = "Output element type", placeholder = "STRING")
    ...
    public @NotNull String summary() {
        return "FlatMap " + this.elementInputType.label() + " -> List<" + this.elementOutputType.label() + ">"
