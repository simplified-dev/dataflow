...
public final class TextMatchesPredicate implements TransformStage<Element, Boolean> {
     ...
     * @return the stage
     */
    public static @NotNull TextMatchesPredicate of(
        @Configurable(label = "Text matches regex", placeholder = "\\d+")
        @NotNull @Language("regexp") String regex
    ) {
        return new TextMatchesPredicate(regex, Pattern.compile(regex));
    }
