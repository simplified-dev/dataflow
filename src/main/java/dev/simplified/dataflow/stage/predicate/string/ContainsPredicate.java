...
public final class ContainsPredicate implements TransformStage<String, Boolean> {
     ...
     * @return the stage
     */
    public static @NotNull ContainsPredicate of(
        @Configurable(label = "Contains", placeholder = "foo")
        @NotNull String needle
    ) {
        return new ContainsPredicate(needle);
    }
