...
public final class OuterHtmlTransform implements TransformStage<Element, String> {
     ...
     * @return the stage
     */
    public static @NotNull OuterHtmlTransform of() {
        return new OuterHtmlTransform();
    }
