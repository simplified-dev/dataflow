...
public final class PrependTransform implements TransformStage<String, String> {
     ...
     * @return the stage
     */
    public static @NotNull PrependTransform of(
        @Configurable(label = "Prefix", placeholder = ">>>")
        @NotNull String prefix
    ) {
        return new PrependTransform(prefix);
    }
