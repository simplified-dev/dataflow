...
public final class SizeTransform<T> implements TransformStage<List<T>, Integer> {
     ...
     */
    public static <T> @NotNull SizeTransform<T> of(
        @Configurable(label = "Element type", placeholder = "STRING")
        @NotNull DataType<T> elementType
    ) {
        return new SizeTransform<>(elementType, DataType.list(elementType));
    }
