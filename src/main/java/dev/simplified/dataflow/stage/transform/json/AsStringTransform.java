...
public final class AsStringTransform implements TransformStage<JsonElement, String> {
     ...
     * @return the stage
     */
    public static @NotNull AsStringTransform of() {
        return new AsStringTransform();
    }
