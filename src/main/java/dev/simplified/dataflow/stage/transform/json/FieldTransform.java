...
public final class FieldTransform implements TransformStage<JsonObject, JsonElement> {
     ...
     * @return the stage
     */
    public static @NotNull FieldTransform of(
        @Configurable(label = "Field name", placeholder = "stats")
        @NotNull String fieldName
    ) {
        return new FieldTransform(fieldName);
    }
