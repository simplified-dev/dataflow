...
public final class ContainsFilter implements FilterStage<String> {
     ...
     * @return the stage
     */
    public static @NotNull ContainsFilter of(
        @Configurable(label = "Contains", placeholder = "foo")
        @NotNull String needle
    ) {
        return new ContainsFilter(needle);
    }
