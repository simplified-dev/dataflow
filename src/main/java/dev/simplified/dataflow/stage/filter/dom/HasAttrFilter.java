...
public final class HasAttrFilter implements FilterStage<Element> {
     ...
     * @return the stage
     */
    public static @NotNull HasAttrFilter of(@NotNull String attributeName) {
        return new HasAttrFilter(attributeName, null);
    }
     ...
     * @return the stage
     */
    public static @NotNull HasAttrFilter of(
        ...
        return new HasAttrFilter(attributeName, expectedValue);
    }
